...
<head>
    ...
    <title>PulseBoard API Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authenticating-requests">
                    ...
                    <ul id="tocify-header-deployment-checks" class="tocify-header">
                <li class="tocify-item level-1" data-unique="deployment-checks">
                    <a href="#deployment-checks">Deployment Checks</a>
                </li>
                                    <ul id="tocify-subheader-deployment-checks" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="deployment-checks-PATCHapi-checks--check_id--complete">
                                <a href="#deployment-checks-PATCHapi-checks--check_id--complete">Mark a deployment check as completed</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="deployment-checks">Deployment Checks</h1>

    

                                <h2 id="deployment-checks-PATCHapi-checks--check_id--complete">Mark a deployment check as completed</h2>
...
<span id="example-requests-PATCHapi-checks--check_id--complete">
...
<span id="example-responses-PATCHapi-checks--check_id--complete">
</span>
<span id="execution-results-PATCHapi-checks--check_id--complete" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-checks--check_id--complete"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-checks--check_id--complete"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-checks--check_id--complete" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-checks--check_id--complete">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-checks--check_id--complete" data-method="PATCH"
      data-path="api/checks/{check_id}/complete"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-checks--check_id--complete', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-checks--check_id--complete"
                    onclick="tryItOut('PATCHapi-checks--check_id--complete');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-checks--check_id--complete"
                    onclick="cancelTryOut('PATCHapi-checks--check_id--complete');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-checks--check_id--complete"
            ...
            <b><code>api/checks/{check_id}/complete</code></b>
        </p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-checks--check_id--complete"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-checks--check_id--complete"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>check_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
 &nbsp;
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="owner_email"                data-endpoint="POSTapi-projects"
...
<p>Must be a valid date. Example: <code>2026-02-26T07:57:10</code></p>
                    ...
                    <h2 id="projects-GETapi-projects--project_id--readiness">Get project deployment readiness</h2>
...
<span id="example-requests-GETapi-projects--project_id--readiness">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-GETapi-projects--project_id--readiness" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-projects--project_id--readiness"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-projects--project_id--readiness"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-projects--project_id--readiness" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-projects--project_id--readiness">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-projects--project_id--readiness" data-method="GET"
      data-path="api/projects/{project_id}/readiness"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-projects--project_id--readiness', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-projects--project_id--readiness"
                    onclick="tryItOut('GETapi-projects--project_id--readiness');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-projects--project_id--readiness"
                    onclick="cancelTryOut('GETapi-projects--project_id--readiness');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-projects--project_id--readiness"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/projects/{project_id}/readiness</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-projects--project_id--readiness"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-projects--project_id--readiness"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
